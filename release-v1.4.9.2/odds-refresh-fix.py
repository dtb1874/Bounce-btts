...
if new_candidates not in text:
    if old_candidates not in text:
        raise SystemExit("selected-only odds candidate anchor not found")
...
print("Applied selected-fixture-only paginated odds refresh with preserve-known-price behaviour")
