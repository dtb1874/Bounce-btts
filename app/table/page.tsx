...
export default async function PublicTablePage(){
  ...
  return <main className="spectatorPage">
    <header className="spectatorHero"><div className="spectatorHeroCopy"><span>PRIVATE SPECTATOR VIEW · SEASON {season?.label??settings?.current_season_label??"2026/27"}</span><h1>BOUNCE</h1><h2>BTTS LEAGUE</h2><p>Current picks, live scores and the league race — read only.</p></div></header>
    ...
    <footer className="spectatorFooter"><div><strong>BOUNCE BTTS LEAGUE</strong><span>Edinburgh · Est 2024</span></div></footer>
  </main>;
}
