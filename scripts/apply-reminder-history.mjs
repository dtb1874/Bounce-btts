...
if (source.includes(oldReleaseVersion)) source = source.replace(oldReleaseVersion, 'const RELEASE_VERSION = "1.12.0";');
else if (!source.includes('const RELEASE_VERSION = "1.12.0";')) throw new Error("Could not align release version");
if (source.includes(oldReleaseDate)) source = source.replace(oldReleaseDate, 'const RELEASE_DATE = "5 Sep 2026";');
else if (!source.includes('const RELEASE_DATE = "5 Sep 2026";')) throw new Error("Could not align release date");
