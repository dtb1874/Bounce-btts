...
if (source.includes(oldReleaseDate)) source = source.replace(oldReleaseDate, 'const RELEASE_DATE = "6 Sep 2026";');
else if (!source.includes('const RELEASE_DATE = "6 Sep 2026";')) throw new Error("Could not align release date");
