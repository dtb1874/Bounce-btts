...
// v1.13.0 sync: retain the 14-day / 12-fixture resilience hotfixes while promoting the UI Foundation release.
...
if (source.includes(oldReleaseVersion)) source = source.replace(oldReleaseVersion, 'const RELEASE_VERSION = "1.13.0";');
else if (source.includes('const RELEASE_VERSION = "1.12.1";')) source = source.replace('const RELEASE_VERSION = "1.12.1";', 'const RELEASE_VERSION = "1.13.0";');
else if (source.includes('const RELEASE_VERSION = "1.12.0";')) source = source.replace('const RELEASE_VERSION = "1.12.0";', 'const RELEASE_VERSION = "1.13.0";');
else if (!source.includes('const RELEASE_VERSION = "1.13.0";')) throw new Error("Could not align release version");
if (source.includes(oldReleaseDate)) source = source.replace(oldReleaseDate, 'const RELEASE_DATE = "7 Sep 2026";');
else if (source.includes('const RELEASE_DATE = "5 Sep 2026";')) source = source.replace('const RELEASE_DATE = "5 Sep 2026";', 'const RELEASE_DATE = "7 Sep 2026";');
else if (source.includes('const RELEASE_DATE = "6 Sep 2026";')) source = source.replace('const RELEASE_DATE = "6 Sep 2026";', 'const RELEASE_DATE = "7 Sep 2026";');
else if (!source.includes('const RELEASE_DATE = "7 Sep 2026";')) throw new Error("Could not align release date");
