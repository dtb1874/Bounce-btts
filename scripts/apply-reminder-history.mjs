...
// v1.12.1 follow-up: fixture availability warning threshold raised to 12 eligible fixtures.
...
if (source.includes(oldReleaseVersion)) source = source.replace(oldReleaseVersion, 'const RELEASE_VERSION = "1.12.1";');
else if (source.includes('const RELEASE_VERSION = "1.12.0";')) source = source.replace('const RELEASE_VERSION = "1.12.0";', 'const RELEASE_VERSION = "1.12.1";');
else if (!source.includes('const RELEASE_VERSION = "1.12.1";')) throw new Error("Could not align release version");
